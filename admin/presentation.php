  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="container">
        ...
        <div class="col-md-4">
            <form method='POST' enctype="multipart/form-data"  action='presentation_upload.php'>
        <div id="from-group">
            <label for="name">Name</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Document Name" required>
        </div>
          <br>
          <div id="form-group">
